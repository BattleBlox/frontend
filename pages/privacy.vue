<template>
  <div class="c-privacy">
    ...
    <ol>
      ...
      <li><a href="#section-2">HOW DO WE USE YOUR INFORMATION?</a></li>
      <li><a href="#section-3">WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a></li>
      <li><a href="#section-4">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></li>
      <li><a href="#section-5">IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</a></li>
    ...
    <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Website, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Website. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at battleblox@tommcclean.me.</p>

    <h4 id="section-8">
      8. WHAT ARE YOUR PRIVACY RIGHTS?
    </h4>
    <p>In Short:  We do not collect sensitive information or have an account based system, if you cease using our service, no account data exists to be deleted.</p>
    ...
    <p>If you have questions or comments about this notice, you may email us at battleblox@tommcclean.me</p>
